    ...
    <>
      <section className="pt-36 pb-16 px-6 lg:px-12">
        <div className="max-w-3xl mx-auto">
          ...
          <h1
            className="text-[clamp(2rem,5vw,4rem)] font-light text-[#181512] leading-[1.02]"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            Privacy Policy
          </h1>
          <p className="mt-3 text-[12px] text-[#181512]/35 font-light">Last updated: April 2026</p>
        </div>
      </section>
      ...
      <section className="pb-24 px-6 lg:px-12">
        <div className="max-w-3xl mx-auto flex flex-col gap-px bg-[#E2D9CE]">
          {sections.map((s) => (
            <div key={s.title} className="bg-[#F9F6F1] px-8 py-8">
              <h2
                className="text-[1.1rem] font-light text-[#181512] mb-3"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                {s.title}
              </h2>
              <p className="text-[13px] text-[#181512]/50 leading-relaxed font-light">{s.body}</p>
            </div>
          ))}
        </div>
